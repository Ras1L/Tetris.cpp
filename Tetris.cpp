...
const int scr_width = 2 * fld_width;
...
void Time(size_t time, int interval)
{
	auto final_time = (time * interval) / 1000;
	auto time_in_min = final_time / 60;
	auto time_in_sec = final_time % 60;
	std::cout << "\nYOUR TIME:  " << time_in_min << " min.  " << time_in_sec << " sec.\n";
}
